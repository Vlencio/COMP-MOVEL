// Exercício Final: Botões "Anterior" e "Próximo" para navegar entre Pokémons
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            if (imagemUrl.isNotEmpty) Image.network(imagemUrl, height: 180),
            if (nome.isNotEmpty) ...[
            ...
            Row(
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: numero > 1 ? irAnterior : null,
